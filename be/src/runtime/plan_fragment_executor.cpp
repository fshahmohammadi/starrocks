...
Status PlanFragmentExecutor::prepare(const TExecPlanFragmentParams& request) {
    ...
    if (request.fragment.__isset.dict_passthrough_column_ids) {
        std::unordered_set<int32_t> ids(request.fragment.dict_passthrough_column_ids.begin(),
                                         request.fragment.dict_passthrough_column_ids.end());
